...
!!! info
    The style guide is always a work in progress, and not all PyFortran90Namelists code
    follows the rules. When modifying PyFortran90Namelists, please fix the style violations
...
!!! info
    A continuous integration check verifies that all PRs made to PyFortran90Namelists have
